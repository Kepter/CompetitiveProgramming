/*
 * UCF High School Programming Tournament, 2018
 *
 * Problem: Alphabet-Rearrange-Inator 3000
 * Author: Shane Rhoads
 *
 * To solve this problem we will be using a modified version of the Trie data structure.
 *
